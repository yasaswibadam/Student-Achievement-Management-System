					...
					<nav id="site-navigation" class="navbar">
						<div class="navbar-offcanvas navbar-offcanvas-touch navbar-offcanvas-right offcanvas-transform js-offcanvas-done" id="js-bootstrap-offcanvas">
							...
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="PublicationIndex.jsp">PUBLICATIONS</a></li>
		      ...
		      <div class="table-responsive">
		      		<table class="table table-bordered table-hover">
						...
						try{
							...
							String sql ="select * from publication where RegID = '"+id+"'";
						...
						%>
										...
										<td><a href="PublicationImage.jsp?id=<%=resultSet.getString("pubid")%>" target="_blank"><button>View Certificate</button></a></td>
										<td><a href="PublicationUpdate.jsp?id=<%=resultSet.getString("pubid")%>"><button>update</button></a></td>
										<td><a href="PublicationDelete.jsp?id=<%=resultSet.getString("pubid")%>"><button>delete</button></a></td>
										</tr>
							<%
								}
							%>
							          ...
							          <tfoot>
							            <tr>
							              <td><a href="PublicationAdd.jsp" style="color:red;"><button>Add</button></a><td>
							            </tr>
							          </tfoot>
							        </table>
						 <% 
