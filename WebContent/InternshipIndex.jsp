				...
				<div class="row">
					<nav id="site-navigation" class="navbar">
						<div class="navbar-offcanvas navbar-offcanvas-touch navbar-offcanvas-right offcanvas-transform js-offcanvas-done" id="js-bootstrap-offcanvas">
								...
								<li class="active"><a href="InternshipIndex.jsp">INTERNSHIPS</a></li>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="welcome-content">
								...
								String sql ="select * from internship where RegID = '"+id+"'";
								...
								%>
										...
										<tr>
											...
											<td><a href="InternshipUpdate.jsp?id=<%=resultSet.getString("intid")%>"><button>update</button></a></td>
											<td><a href="InternshipDelete.jsp?id=<%=resultSet.getString("intid")%>"><button>delete</button></a></td>
											</tr>									
							<%
								}
							%>
							          ...
							          <tfoot>
							            <tr>
							              <td><a href="InternshipAdd.jsp" style="color:red;"><button>Add</button></a></td>
							            </tr>
							          </tfoot>
							        </table>
