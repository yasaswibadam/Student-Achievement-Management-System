...
<head>
					...
					<nav id="site-navigation" class="navbar">
						<div class="navbar-offcanvas navbar-offcanvas-touch navbar-offcanvas-right offcanvas-transform js-offcanvas-done" id="js-bootstrap-offcanvas">
							...
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="SearchAllCompetitive.jsp">COMPETITIVE EXAMS</a></li>
							</ul>
						</div>
					</nav>
				</div>
	...
	<table class="table table-bordered table-hover">
						...
						try{
						    ...
						    sql ="select ceid,examname,organizer,score_grade,startperiod,endperiod from competitive_exams where startperiod >= '"+sdate+"' and endperiod <= '"+edate+"'";
