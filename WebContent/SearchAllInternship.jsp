...
<head>
					...
					<nav id="site-navigation" class="navbar">
						<div class="navbar-offcanvas navbar-offcanvas-touch navbar-offcanvas-right offcanvas-transform js-offcanvas-done" id="js-bootstrap-offcanvas">
							...
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="SearchAllInternship.jsp">INTERNSHIPS</a></li>
	...
	<table class="table table-bordered table-hover">
						...
						try{
							...
							String sql;
							sql ="select intid,companyname,intlocation,worknature,intstatus,startperiod,endperiod from internship where startperiod >= '"+sdate+"' and endperiod <= '"+edate+"'";
